class RepoRecall < Formula
  ...
  homepage "https://forgejo.coilysiren.me/coilyco-flight-deck/repo-recall"
  url "https://forgejo.coilysiren.me/coilyco-flight-deck/repo-recall.git", tag: "v0.46.0", revision: "9bc81762412579a4f19a10d8784ded37f37cdaea"
  license "MIT"
  head "https://forgejo.coilysiren.me/coilyco-flight-deck/repo-recall.git", branch: "main"
