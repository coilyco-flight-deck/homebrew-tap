class SessionLatticePuller < Formula
  ...
  homepage "https://forgejo.coilysiren.me/coilyco-flight-deck/session-lattice"
  # url/tag/revision are rewritten by the release pipeline at every tag push.
  url "https://forgejo.coilysiren.me/coilyco-flight-deck/session-lattice.git", tag: "v0.10.3", revision: "ec990cb9724ba034432909ee077a23f79974ef0c"
  license "MIT"
  head "https://forgejo.coilysiren.me/coilyco-flight-deck/session-lattice.git", branch: "main"

  depends_on "coilyco-flight-deck/tap/session-lattice"
  ...
  def install
    ...
    (pkgshare/"README.md").write <<~EOS
      ...
      service; the binary comes from coilyco-flight-deck/tap/session-lattice.
      See https://forgejo.coilysiren.me/coilyco-flight-deck/session-lattice/src/branch/main/AGENTS.md.
    EOS
  end
